...
if(args[0]==="workflow"&&args[1]==="agent"){
  ...
  if(!jobId) throw new Error("usage: workflow agent --job-id <job-id>");
  ...
  console.log(JSON.stringify({jobId,agent:"autonomous",decisions:result.decisions,...result.workflow},null,2));
